...
function Header() {
    ...
    const handleSelect =(ranges: { selection: { startDate: React.SetStateAction<Date>; endDate: React.SetStateAction<Date>; }; })=> {
    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
        ...
        (<div className='flex flex-col col-span-3 mx-auto'>
            ...
            <div className='flex '>
                ...
                <button  onClick={()=> setSearchInput(' ')} className='flex-grow text-gray-500'>Clear</button>
